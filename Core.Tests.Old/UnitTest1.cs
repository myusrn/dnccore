...
namespace Core.Tests
{
    ...
    public class UnitTest1
    {
        ...
        {
            PublicClientApplication app = new PublicClientApplication(clientId, $"{signinBaseAddress}/{tenantId}/", FileTokenCache.GetUserCache());  // tenant only wsa;
            AuthenticationContext acNca = new AuthenticationContext(authority, FileTokenCache.GetUserCache());
            //AuthenticationContext acNca = new AuthenticationContext(authority, AzRedisTokenCache().GetUserCache());
